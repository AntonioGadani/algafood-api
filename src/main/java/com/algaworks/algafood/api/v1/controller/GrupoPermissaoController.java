...
@RestController
//antes:@RequestMapping(value="/grupos/{grupoId}/permissoes"	//aula 20.14
@RequestMapping(path = "/v1/grupos/{grupoId}/permissoes")
public class GrupoPermissaoController{		//aula 12.15, 19.34, 20.14, 23.34, 23.40
	@Autowired
	...
	public CollectionModel<PermissaoModel> listar(@PathVariable Long grupoId) {
		...
		permissoesModel.add(algaLinks.linkToGrupoPermissoes(grupoId));	//aula 23.40
		
				if (algaSecurity.podeEditarUsuariosGruposPermissoes()) {	//aula 23.40
	...
	/* após .removeLinks()	.add(algaLinks.linkToGrupoPermissoes(grupoId))
